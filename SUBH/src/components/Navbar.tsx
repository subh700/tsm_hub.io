      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">SUBH</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/concepts" className={`nav-link ${isActive('/concepts') ? 'active' : ''}`}>
              Concepts
            </Link>
            <Link to="/models" className={`nav-link ${isActive('/models') ? 'active' : ''}`}>
              Models
            </Link>
            <Link to="/comparison" className={`nav-link ${isActive('/comparison') ? 'active' : ''}`}>
              Comparison
            </Link>
            <button
